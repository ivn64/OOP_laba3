...
Rhombus::Rhombus()
{
	vertDiagonal = 360;
	horizDiagonal = 400;
	frameСolor.rgbtRed = 0;
	frameСolor.rgbtGreen = 255;
	frameСolor.rgbtBlue = 0;
}
Rhombus::Rhombus(int tVertDiagonal, int tHorizDiagonal, RGBTRIPLE tFrameСolor)
{
	vertDiagonal = tVertDiagonal;
	horizDiagonal = tHorizDiagonal;
	frameСolor.rgbtRed = tFrameСolor.rgbtRed;
	frameСolor.rgbtGreen = tFrameСolor.rgbtGreen;
	frameСolor.rgbtBlue = tFrameСolor.rgbtBlue;
}
